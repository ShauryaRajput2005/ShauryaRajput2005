...
I am a Software Engineer specializing in scalable full-stack development and artificial intelligence. My core focus is on architecting high-performance systems and integrating machine learning models into production environments. With a strong product engineering mindset, I bridge the gap between complex algorithmic solutions and seamless user experiences.

**Expertise Areas:**
- Scalable Software Architecture & System Design
- Artificial Intelligence & Deep Learning Models
- Full Stack Web Development (React, Next.js, Node.js)
- Cloud Infrastructure & Deployment

**Open To:** Full-time Software Engineering roles, AI/ML Engineering positions, and high-impact open-source contributions.
...
### Languages
<img src="https://skillicons.dev/icons?i=python,js,ts,cpp,java,bash&perline=10&theme=dark" />

### Frontend
<img src="https://skillicons.dev/icons?i=react,nextjs,tailwind,html,css,vite,figma&perline=10&theme=dark" />

### Backend & Databases
<img src="https://skillicons.dev/icons?i=nodejs,express,mongodb,postgres,mysql,prisma&perline=10&theme=dark" />

### Cloud, DevOps & Tooling
<img src="https://skillicons.dev/icons?i=aws,docker,linux,git,github,vscode,vercel,netlify&perline=10&theme=dark" />
...
| **Machine Learning** | Advanced | Scikit-Learn, XGBoost, Predictive Modeling, Regression |
| **Data Engineering** | Intermediate | Pandas, NumPy, Data Pipeline Architecture |
| **Computer Vision** | Intermediate | OpenCV, Image Processing, Object Detection |
...
<details>
  ...
  A high-performance analytics dashboard designed for enterprise data visualization.
  
  | Stack | Scale | Performance | Security | Impact | Repository |
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | React, Next.js, TypeScript | 10k+ Records | Sub-second load | JWT, OAuth2 | Enhanced data visibility | [View Repo](https://github.com/ShauryaRajput2005) |
  
  *Architected the frontend infrastructure to handle real-time data streams utilizing WebSockets and advanced state management. Optimized rendering cycles for large datasets, achieving a 40% reduction in memory overhead.*
</details>

<details>
  <summary><b>Intelligent Recommendation Engine</b></summary>
  <br/>
  
  A machine learning pipeline for personalized content delivery.
  
  | Stack | Scale | Performance | Security | Impact | Repository |
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | Python, PyTorch, FastAPI | 1M+ Vectors | 50ms inference | API Key | 25% engagement lift | [View Repo](https://github.com/ShauryaRajput2005) |
  
  *Developed a deep learning recommendation model utilizing collaborative filtering and vector embeddings. Deployed as a scalable microservice with FastAPI, handling high-throughput inference requests.*
</details>
...
Engineered scalable frontend interfaces and integrated robust APIs for enterprise clients.
- Architected responsive, high-performance UI components reducing page load times by 30%.
- Collaborated with cross-functional teams to deliver product features ahead of schedule.
- Implemented modern state management and secure authentication flows.

`React` `TypeScript` `TailwindCSS` `System Architecture`
...
| Recognition | Details |
| :--- | :--- |
| **Top 1% Contributor** | Recognized for consistent open-source contributions. |
| **Hackathon Winner** | Built an AI-powered accessibility tool in 48 hours. |
| **Academic Excellence** | Ranked in the top percentile of the Computer Science cohort. |
...
<div align="center">
  <a href="#"><img src="https://img.shields.io/badge/LeetCode-500+_Problems-FFA116?style=for-the-badge&logo=leetcode&logoColor=black" /></a>
  ...
  <a href="#"><img src="https://img.shields.io/badge/HackerRank-5_Star_Coder-00EA64?style=for-the-badge&logo=hackerrank&logoColor=black" /></a>
  <a href="#"><img src="https://img.shields.io/badge/CodeChef-4_Star-5B4638?style=for-the-badge&logo=codechef&logoColor=white" /></a>
</div>
...
```yaml
learning: [ "Advanced Distributed Systems", "Transformers & LLMs" ]
building: [ "Enterprise SaaS Architecture", "Real-time Data Pipelines" ]
exploring: [ "Web3 Integration", "Rust Performance Optimization" ]
open_to: [ "Software Engineer Roles", "AI Researcher Positions" ]
```
